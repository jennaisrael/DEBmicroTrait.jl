...
using JLD
#Edit the number of initial cells to be 10^5 as opposed to 10^2
########################################
# I/O
...
ρ_bulk          = 1.0 # g/cm^3
N_cells         = 1e5 #Where N cells is number of cells per gram of soil/ solution
Bio_0           = N_cells*1e6*ρ_bulk*dry_mass./12.011
########################################

########################################
# I/O, change to my directory
save("./files/output/isolates_batch_init_10_5.jld", "Bio0", Bio_0, "Md", dry_mass, "rhoB", ρ_bulk, "Ncells", N_cells)
########################################
