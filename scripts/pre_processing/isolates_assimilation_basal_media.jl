...
##only 1 metabolite so don't need this step
#df_media_raw            = CSV.read(joinpath(dir, "files/input/basal_medium.csv"), DataFrame, missingstring="N/A")
...
df_metabolites          = CSV.read(joinpath(dir, "files/input/basal_medium_0.75mM_G_LG.csv"), DataFrame, missingstring="N/A")
########################################
...
save("./files/output/isolates_assimilation_basal_medium_0.75mM_G_LG.jld", "rho", ρ_ps, "NSB", N_SB, "KD", K_D, "yEM", y_EM, "yDE", y_DEs, "NC", N_C)