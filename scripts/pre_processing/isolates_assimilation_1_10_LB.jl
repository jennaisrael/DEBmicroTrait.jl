...
#write this to a CSV
CSV.write(joinpath(dir, "files/output2/1_10_LB_medium_unique.csv"),unique_metabolites)
...
save("./files/output/isolates_assimilation_1_10_LB.jld", "rho", ρ_ps, "NSB", N_SB, "KD", K_D, "yEM", y_EM, "yDE", y_DEs, "NC", N_C)