...
##############################################
#EDIT for 1/100 R2A multiply column "Concentration" by 0.1
dil_100(conc) = conc .* 0.1
df_media_dilute=transform!(df_media_raw, :Concentration => dil_100 => :Concentration)
...
#write this to a CSV
CSV.write(joinpath(dir, "files/output2/1_100_R2A_medium_unique.csv"),unique_metabolites)
...
save("./files/output/isolates_assimilation_100_R2A.jld", "rho", ρ_ps, "NSB", N_SB, "KD", K_D, "yEM", y_EM, "yDE", y_DEs, "NC", N_C)